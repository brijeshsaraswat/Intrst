import React, { useEffect,useContext,useFetch,useState } from 'react';
...
export function Article({location,match}){
	...
	console.log("user:",user,"authors:",authors,'articles:',articles);
	useEffect(()=>{
	...
	return(
		<StyledArticle className="master-content-page article">
			...
			<div className="article-title">hello</div>
